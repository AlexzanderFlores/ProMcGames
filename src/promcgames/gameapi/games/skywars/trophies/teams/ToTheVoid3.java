...
public class ToTheVoid3 extends Trophy {
	...
	public static ToTheVoid3 getInstance() {
		if(instance == null) {
			new ToTheVoid3();
		}
		return instance;
	...
	public ItemStack getIcon() {
		return new ItemCreator(Material.SNOW_BALL).setAmount(3).setName("&aTo The Void! 3").
