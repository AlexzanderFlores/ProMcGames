...
public class ToTheVoid1 extends Trophy {
	...
	public static ToTheVoid1 getInstance() {
		if(instance == null) {
			new ToTheVoid1();
		}
		return instance;
	...
	public ItemStack getIcon() {
		return new ItemCreator(Material.SNOW_BALL).setAmount(1).setName("&aTo The Void! 1").
